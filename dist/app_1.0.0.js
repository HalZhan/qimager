...
/***/ function(module, exports, __webpack_require__) {
	...
	const header_area_component_1 = __webpack_require__(30);
	const effect_area_component_1 = __webpack_require__(36);
	const act_item_component_1 = __webpack_require__(38);
	const stage_area_component_1 = __webpack_require__(41);
	const shared_service_1 = __webpack_require__(34);
	const app_routes_module_1 = __webpack_require__(44);
	...
	AppModule = __decorate([
	    core_1.NgModule({
	        ...
	        declarations: [
	            ...
	            effect_area_component_1.EffectAreaComponent,
	            act_item_component_1.ActItemComponent,
	            stage_area_component_1.StageAreaComponent
	        ],
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const imager_1 = __webpack_require__(31);
	const shared_service_1 = __webpack_require__(34);
	/**
	 * 选择器
	 */
	...
	let HeaderAreaComponent = class HeaderAreaComponent {
	    constructor(sharedSerivce) {
	        this.sharedSerivce = sharedSerivce;
	        this.sharedData = sharedSerivce.getSharedData();
	    }
	    ngAfterViewInit() {
	        let img = document.querySelector(SELECTORS.IMAGER);
	        if (this.sharedData) {
	            this.sharedData.imager = new imager_1.Imager({ img });
	        ...
	        if (event && event.target && this.sharedData.imager && event.target.files[0]) {
	            ...
	            setTimeout(() => {
	                this.sharedData.imager.loadImageFile(event.target.files[0])
	                    .then(data => {
	                    if (data.status === imager_1.STATUS.SUCESS) {
	     ...
	     */
	    openFile() {
	        let imageInput = document.querySelector(SELECTORS.IMAGE_INPUT);
	        if (imageInput) {
	            imageInput.click();
	        }
	    }
	...
	HeaderAreaComponent = __decorate([
	    core_1.Component({
	...
	exports.HeaderAreaComponent = HeaderAreaComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const stack_1 = __webpack_require__(33);
	/**
	 * 状态值
	 */
	exports.STATUS = {
	...
	class Imager {
	    constructor(opt = {}) {
	        ...
	        this._actStack = null;
	        this._stack = null;
	        this._operateStack = null;
	        this._curPSEffect = '';
	        this._curActEffect = '';
	        this._doms['img'] = opt['img'];
	        this._psStack = new stack_1.Stack({ size: STACK_SIZE });
	        this._actStack = new stack_1.Stack({ size: STACK_SIZE });
	        this._stack = new stack_1.Stack({ size: STACK_SIZE });
	        this._operateStack = new stack_1.Stack();
	    }
	    /**
	     * 初始化
	     *
	    ...
	    _initLayer() {
	        return new Promise((resolve, reject) => {
	            let img = this._doms['img'] || null;
	            if (img) {
	                img.loadOnce(() => {
	                    try {
	                        this._originLayer = $AI(img);
	                        resolve({
	                            status: exports.STATUS.SUCESS,
	                            data: {
	                                dataUrl: img.src
	                            }
	                        });
	    ...
	    reset() {
	        return this._initLayer()
	            .then(data => {
	            if (data.status === exports.STATUS.SUCESS) {
	    ...
	    act(opt = {}) {
	        return new Promise((resolve, reject) => {
	            ...
	            if (this.getValidActEffect(effect) && this._layer) {
	                if (effect === exports.EFFECT_ORIGIN) {
	     ...
	     * @memberOf Imager
	     */
	    getValidPSEffect(effect = '') {
	        if (effect) {
	            for (let k in exports.EFFECTS_PS) {
	                if (k === effect || exports.EFFECTS_PS[k] === effect) {
	                    return k;
	                }
	            }
	        }
	        ...
	        return new Promise((resolve, reject) => {
	            ...
	            if (this._layer && img && effect) {
	                try {
	                    ...
	                    else if (effect === exports.EFFECT_ORIGIN) {
	    ...
	    undo(opt = null) {
	        if (this._layer) {
	            ...
	            return Promise.resolve({
	                status: exports.STATUS.SUCESS,
	                data: {
	                    dataUrl: this._stack.load(stack_1.FLAGS_STACK.BOTTOM)
	                }
	            });
	        }
	        return Promise.resolve({
	    ...
	    redo(opt = null) {
	        if (this._layer) {
	            ...
	            return Promise.resolve({
	                status: exports.STATUS.SUCESS,
	                data: {
	                    dataUrl: this._stack.load(stack_1.FLAGS_STACK.TOP)
	                }
	            });
	        }
	        return Promise.resolve({
	     ...
	     * @memberOf Imager
	     */
	    getValidActEffect(effect = '') {
	        if (effect) {
	            for (let k in exports.EFFECTS_ACT) {
	                if (effect === k || effect === exports.EFFECTS_ACT[k]) {
	                    return k;
	                }
	            }
	        }
	     ...
	     * @memberOf Imager
	     */
	    loadImageFile(fileUrl = null) {
	        let reader = new FileReader();
	        let self = this;
	        return new Promise((resolve, reject) => {
	            reader.readAsDataURL(fileUrl);
	            reader.onload = function () {
	                let img = self._doms['img'];
	                img.src = this.result;
	                resolve({
	                    status: exports.STATUS.SUCESS
	                });
...
/***/ function(module, exports) {
	...
	class Stack {
	     ...
	     */
	    load(direction = 0) {
	        if (direction === exports.FLAGS_STACK.TOP) {
	            this._moveTop();
	        }
	        else if (direction === exports.FLAGS_STACK.BOTTOM) {
	            this._moveBottom();
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const imager_1 = __webpack_require__(31);
	const shared_service_1 = __webpack_require__(34);
	let EffectAreaComponent = class EffectAreaComponent {
	    constructor(sharedSerivce) {
	        this.sharedSerivce = sharedSerivce;
	        this.PS_PICTURE_NAMES = [
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const ActItem_1 = __webpack_require__(39);
	let ActItemComponent = class ActItemComponent {
	    constructor() {
	...
	__decorate([
	    core_1.Input(),
	    __metadata("design:type", ActItem_1.ActItem)
	], ActItemComponent.prototype, "actItem", void 0);
	__decorate([
	    core_1.Output(),
	    __metadata("design:type", core_1.EventEmitter)
	], ActItemComponent.prototype, "changeEvent", void 0);
	__decorate([
	    core_1.Output(),
	    __metadata("design:type", core_1.EventEmitter)
	], ActItemComponent.prototype, "selectEvent", void 0);
	ActItemComponent = __decorate([
	    core_1.Component({
	        selector: 'act-item',
	...
	exports.ActItemComponent = ActItemComponent;
...
/***/ function(module, exports) {
	...
	exports.ActItemOption = ActItemOption;
	class ActItem {
	    constructor() {
	        this.actName = '';
	        this.actEffect = '';
	        ...
	        this.selected = false;
	        this.options = [];
	        this.negativeTitle = '取消';
	        this.positiveTitle = '确定';
	        this.negativeCb = function () { };
	        this.positiveCb = function () { };
	    }
	}
	exports.ActItem = ActItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	let StageAreaComponent = class StageAreaComponent {
	    constructor(sharedService) {
	        this.sharedService = sharedService;
	        this.isOrigin = false;
	        this.defaultUrl = '../../../public/slicing/images/stop.jpg';
	        this.sharedData = sharedService.getSharedData();
	    }
	    toggleOrigin() {
	        let imgOrigin = document.querySelector(SELECTORS.IMG_ORIGIN), imgEffect = document.querySelector(SELECTORS.IMG_EFFECT);
	...
	exports.StageAreaComponent = StageAreaComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const core_1 = __webpack_require__(3);
	const router_1 = __webpack_require__(45);
	const routes = [];
